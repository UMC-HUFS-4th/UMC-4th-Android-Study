...
public final class ActivityMain3Binding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvMain3;

  private ActivityMain3Binding(@NonNull ConstraintLayout rootView, @NonNull TextView tvMain3) {
    this.rootView = rootView;
    this.tvMain3 = tvMain3;
  }
  ...
  public static ActivityMain3Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.tv_main3;
      TextView tvMain3 = ViewBindings.findChildViewById(rootView, id);
      if (tvMain3 == null) {
        break missingId;
      }

      return new ActivityMain3Binding((ConstraintLayout) rootView, tvMain3);
    }
